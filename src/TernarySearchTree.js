//based verrry strongly off of implementation here https://github.com/mattpage/ternary-search-tree
...
var TernarySearchTree = (function(){
    ...
    TernarySearchTree.prototype._createNode = function(c){
        return {
            val: c,
            end: false,
            left: null,
    ...
    TernarySearchTree.prototype._insert = function(node, str, data){
        var len = str.length;
     ...
     * @return undefined
     */
    TernarySearchTree.prototype._insertManyRecurse = function(strs, begin, end, data){
        if (end == begin) {
            return;
        }
    ...
    TernarySearchTree.prototype._search = function(node, str) {
        if(!node) {
            return null;
        }
    ...
    TernarySearchTree.prototype._traverse = function(node, cb) {
        if (!node){
            return;
        }
     ...
     */
    TernarySearchTree.prototype.add = function(str, data){
     ...
     * @return undefined
     */
    TernarySearchTree.prototype.addMany = function(strs, data) {
     ...
     */
    TernarySearchTree.prototype.empty = function(){
        this.root = null;
        this.entries = 0;
    };

    /**
     * Test if the tree contains a string
     * @param {String} - the string to test for
     * @retuns {Boolean}
     */
    TernarySearchTree.prototype.contains = function(str) {
        var ret = this._search(this.root, str);

        if(ret) return ret.end;
     ...
     * @returns {Object|null}
     */
    TernarySearchTree.prototype.search = function(str) {
     ...
     */
    TernarySearchTree.prototype.traverse = function(cb) {
     ...
     * @return {Array|null}
     */
    TernarySearchTree.prototype.partialMatch = function(str){
        var results = [],
            cb,
            node;
     ...
     * @returns {Number}
     * gotta do some wierd things to define a getter on a prototype
     * fun
     */
    Object.defineProperty(TernarySearchTree.prototype, 'length', {
        get: function length() {
            return this.entries;
        }
    });
